    ...
    winrt::hstring ActionArgFactory::GetNameForAction(Model::ShortcutAction action, Windows::ApplicationModel::Resources::Core::ResourceContext context)
    {
        ...
        static auto actionNames = []() {
            return std::unordered_map<ShortcutAction, wil::zwstring_view>{
                ...
                { ShortcutAction::EqualizePanes, USES_RESOURCE(L"EqualizePanesCommandKey") },
                ...
                { ShortcutAction::SharePaneOnLan, USES_RESOURCE(L"SharePaneOnLanCommandKey") },
                { ShortcutAction::StopSharePane, USES_RESOURCE(L"StopSharePaneCommandKey") },
                { ShortcutAction::ConnectSharedSession, USES_RESOURCE(L"ConnectSharedSessionCommandKey") },
                { ShortcutAction::ConnectSharedSessionViaSsh, USES_RESOURCE(L"ConnectSharedSessionViaSshCommandKey") },
